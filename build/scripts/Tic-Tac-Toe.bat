...
@rem ##########################################################################
@rem
@rem  Tic-Tac-Toe startup script for Windows
@rem
@rem ##########################################################################
...
set CLASSPATH=%APP_HOME%\lib\Tic-Tac-Toe-1.0-SNAPSHOT.jar

@rem Execute Tic-Tac-Toe
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %TIC_TAC_TOE_OPTS%  -classpath "%CLASSPATH%" tictactoe.Main %CMD_LINE_ARGS%
